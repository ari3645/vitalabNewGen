<?php
session_start();
if (!isset($_SESSION['id_utilisateur']) || $_SESSION['id_utilisateur'] == null || $_SESSION['role'] != 1) {
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="dropdown">
          <button href="" class="btn41-43 btn-42" style="padding-right:25%" onclick="logouta()">Déconnexion</button>
          <script>
