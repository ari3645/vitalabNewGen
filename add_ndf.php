...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sql=$pdo->query("INSERT INTO note_de_frais (date_facture, montant_facture, lieu_facture, id_frais, statut) VALUES ('$date_facture', '$montant_facture', '$lieu_facture', '$type_frais', '$statut')");
