...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($intitule) && !empty($date_facture) && !empty($montant_facture) && !empty($lieu_facture) && !empty($type_frais) && !empty($id_utilisateur) && !empty($statut) && ($type_frais <= 10) && ($type_frais >= 1)){
        try {
